...
export function ChallengeLibrary({ 
  ...
  const categories = [
    ...
    { id: 'contests', name: 'Contests', icon: Target }
  ];
            ...
            <div className="flex-1 relative">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {challenge.isPremium && (
                    <span className="text-xs bg-orange-500 px-2 py-0.5 rounded text-white">
                      Premium
                    </span>
                  )}
                  {((challenge.tier === 1 && !hasCompletedTier0 && !challenge.isPremium) || (challenge.tier === 2 && !hasCompletedTier1)) && (
