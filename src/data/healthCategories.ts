...
export const HEALTH_CATEGORIES: HealthCategory[] = [
  ...
  },
  {
    id: "contests",
    name: "Contests",
    subtitle: "Community Challenges & Competitions",
    description: "The Contests category focuses on special challenges and competitions that bring the community together for shared goals and achievements.",
    keyComponents: [
